@extends('layouts.app')
@section('title', 'Editar Proyectos | Proyectos | SIVHE')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-7 col-8 align-self-center">
                    <h3 class="text-themecolor">Editar Proyectos</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Proyectos</a></li>
                        <li class="breadcrumb-item active">Editar Proyectos</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Editar Proyectos</h4>
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form action="{{route('proyectos.update', $proyectos->id_proyecto)}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="cod_proyecto" id="cod_proyecto"
                                                   placeholder="Ingresa Codigo" class="form-control" value="{{$proyectos->cod_proyecto}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="nombre_proyecto" id="nombre_proyecto"
                                                   placeholder="Nombre de Proyecto" class="form-control" value="{{$proyectos->nombre_proyecto}} " required>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="periodo_ejecucion" id="periodo_ejecucion"
                                                   placeholder="Periodo" class="form-control" value="{{$proyectos->periodo_ejecucion}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                        <label class="col-md-3 text-md-right col-form-label"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="duracion" id="duracion" placeholder="Duracion"
                                                   class="form-control " value="{{$proyectos->duracion}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                        <label class="col-md-3 text-md-right col-form-label"
                                        ...
                                        <div class="col-md-6">
                                            <select name="estado_proyecto" id="estado_proyecto"
                                                ...
                                                <option value="0" {{ $proyectos->estado_proyecto == 0 ? 'selected' : ''}}>Abierto</option>
                                                <option value="1" {{ $proyectos->estado_proyecto == 1 ? 'selected' : ''}}>Cerrado</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="comentarios" id="comentarios" placeholder="Comentarios" class="form-control" rows="3" >{{$proyectos->comentario}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                        <label class="col-md-3 text-md-right col-form-label" for="nombre">Nuevo
                                            Archivo</label>
                                        <div class="col-md-6">
                                            <input type="file" accept="*"  name="documento" id="documento" class="custom-file-input" id="customFileLang" lang="es">
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <div class="checkbox checkbox-css">
                                                <input type="checkbox" id="cssCheckbox1" name="carpetas" {{ $proyectos->carpetas == 1 ? 'checked' : ''}}/>
                                                <label for="cssCheckbox1"></label>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id_user" id="id_user" value="{{ Auth::user()->id }}">
                                    <input type="hidden" name="documento_old" id="documento_old" value="{{$proyectos->documento}}">
