                ...
                <div class="col-md-8 offset-md-2">
                    <form action="{{route('temporales.store')}}" method="post" enctype="multipart/form-data" data-parsley-validate="true" autocomplete="off" >
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input readonly type="text" name="fecha" id="fecha"  placeholder="Ingresa Fecha" class="form-control" data-parsley-required="true" data-parsley-required-message="Por favor Ingresa Fecha" value="{{$fecha}}">
                            </div>
                        </div>
