    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="container">
                ...
                @endif
                <form action="{{route('actividades.update',$actividades->id_actividades)}}" method="post"
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="nombre_actividades" id="nombre_actividades"
                                           ...
                                           value="{{$actividades->nombre_actividades}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="cod_proyecto" id="cod_proyecto"
                                           ...
                                           value="{{$actividades->cod_proyecto}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="costo_presupuestado" id="costo_presupuestado"
                                           ...
                                           value="{{$actividades->costo_presupuestado}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="estatus" id="estatus" placeholder="Ingresa Estados"
                                           class="form-control" value="{{$actividades->estatus}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="tiempo_ejecucion" id="tiempo_ejecucion"
                                           ...
                                           value="{{$actividades->tiempo_ejecucion}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fr043" id="fr043" placeholder="Ingresa FR043"
                                           class="form-control" value="{{$actividades->fr043}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="operador" id="operador" placeholder="Ingresa Operadpr"
                                           class="form-control" value="{{$actividades->operador}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="visita_terreno" id="visita_terreno"
                                           ...
                                           value="{{$actividades->visita_terreno}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fecha_estimada" id="fecha_estimada"
                                           ...
                                           value="{{$actividades->fecha_estimada}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fase" id="fase" placeholder="Ingresa Fase"
                                           class="form-control" value="{{$actividades->fase}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="avance" id="avance" placeholder="Ingresa Avance"
                                           class="form-control" value="{{$actividades->avance}}">
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                    <textarea name="comentarios" id="comentarios" placeholder="Comentarios"
                                              ...
                                              data-parsley-required-message="Por favor Ingresa Comentario">{{$actividades->comentarios}}</textarea>
                                </div>
                            </div>
