...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item">Editar Cargos</li>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Editar Cargos</h4>
        </div>
        <div class="panel-body">
            <div class="container">
                ...
                <div class="col-md-8 offset-md-2">
                    <form action="{{route('cargos.update', $cargos->id)}}" method="post" enctype="multipart/form-data" data-parsley-validate="true" autocomplete="off" >
                        @csrf
                        @method('PUT')
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label" for="cod_proyecto">Nombre de Cargo</label>
                            <div class="col-md-6">
                                <input type="text" name="nombre" id="nombre" placeholder="Nombre de Cargo" class="form-control" data-parsley-required="true" data-parsley-required-message="Por favor Ingresa Cargo" value="{{$cargos->nombre}}">
                            </div>
                        </div>
