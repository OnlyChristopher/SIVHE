...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="header" class="header navbar-inverse">
        ...
        <div class="navbar-header">
            ...
            <a href="{{action('HomeController@index')}}" class="navbar-brand"><img
            ...
            <li class="dropdown navbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    @if(Auth::user()->profile == 1)
                        ...
                        <a href="{{ route('usuarios.create') }}" class="dropdown-item">Registrar Usuarios</a> @endif
                ...
                @if(Auth::user()->profile == 1 || Auth::user()->profile == 2 || Auth::user()->profile == 3 || Auth::user()->profile == 4)
                    <li class="has-sub active @yield('clase-open-empleados') @yield('clase-active-documentos')">
                        ...
                        <ul class="sub-menu" style="@yield('clase-open-documentos-block')">
                            <li class="@yield('clase-active-registro')"><a
                                        href="{{route('personal.index')}}">{{ __('Registro de Empleados') }}</a>
                            </li>
                            <li class="@yield('clase-active-consulta')"><a
                                        href="{{route('consultas.index')}}">{{ __('Consulta de Empleados') }}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-sub active @yield('clase-open-vehiculos') @yield('clase-active-documentos')">
                        ...
                        <ul class="sub-menu" style="@yield('clase-open-documentos-block')">
                            ...
                            <li class="@yield('clase-active-procedimientos')"><a
                                        href="#">{{ __('Retiro y Devolucion de Vehículos') }}</a>
                            </li>
                            
                            <li class="@yield('clase-active-procedimientos')"><a
                                        href="#">{{ __('Programar Mantenimiento') }}</a>
                            </li>
                            
                            <li class="@yield('clase-active-procedimientos')"><a
                                        href="#">{{ __('Consulta de Vehiculos') }}</a>
                            </li>
                        </ul>
...
<script src="{{ asset('assets/plugins/bootstrap-datepicker/locales/bootstrap-datepicker.es.min.js') }}"
