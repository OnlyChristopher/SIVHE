@extends('layouts.app')
@section('title', 'Editar Sub Carpeta | Proyectos | SIVHE')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-7 col-8 align-self-center">
                    <h3 class="text-themecolor">Editar Sub Carpeta</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Proyectos</a></li>
                        <li class="breadcrumb-item active">Editar Sub Carpeta</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Editar Sub Carpeta</h4>
                            @if ($errors->any())
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form action="{{route('carpetasProyectosUpdate',$folderSecundarios->id)}}" method="post" enctype="multipart/form-data"  class="needs-validation" autocomplete="off" novalidate >
                                    @csrf
                                    @method('PUT')
