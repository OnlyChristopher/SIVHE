@extends('layouts.app')
@section('title', 'Editar Cargos | Administración | SIVHE')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-7 col-8 align-self-center">
                    <h3 class="text-themecolor">Editar Cargos</h3>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Editar Cargos</h4>
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form action="{{route('cargos.update', $cargos->idcargo)}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="nombre" id="nombre"
                                                   placeholder="Ingresa Nombre Cargo" class="form-control" value="{{$cargos->nombre}}" required>
                                        </div>
                                    </div>
