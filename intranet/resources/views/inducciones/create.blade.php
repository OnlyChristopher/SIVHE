@extends('layouts.app')
@section('title', 'Crear Inducción | Administración | SIVHE')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-7 col-8 align-self-center">
                    <h3 class="text-themecolor">Crear Inducción</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Administración</a></li>
                        <li class="breadcrumb-item active">Crear Inducción</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Crear Inducción</h4>
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form action="{{route('inducciones.store')}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="numinduccion" id="numinduccion"
                                                   placeholder="Ingresa Induccion" class="form-control" required>
                                        </div>
                                    </div>
