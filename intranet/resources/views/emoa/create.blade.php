@extends('layouts.app')
@section('title', 'Crear EMOA | Administración | SIVHE')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-7 col-8 align-self-center">
                    <h3 class="text-themecolor">Crear EMOA</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Administración</a></li>
                        <li class="breadcrumb-item active">Crear EMOA</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Crear EMOA</h4>
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form action="{{route('emoa.store')}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="numemoa" id="numemoa"
                                                   placeholder="Ingresa EMOA" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="observaciones" id="observaciones" placeholder="Ingresar Observaciones" class="form-control" rows="3" ></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-10">
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="file" accept="application/pdf"  name="documento" id="documento" class="custom-file-input" id="customFileLang" lang="es" required>
