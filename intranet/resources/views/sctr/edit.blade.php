@extends('layouts.app')
@section('title', 'Editar SCTR | Administración | SIVHE')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-7 col-8 align-self-center">
                    <h3 class="text-themecolor">Editar SCTR</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Administración</a></li>
                        <li class="breadcrumb-item active">Editar SCTR</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Editar SCTR</h4>
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form action="{{route('sctr.update', $sctr->idsctr)}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="numsctr" id="numsctr"
                                                   placeholder="Ingresa SCTR" class="form-control" value="{{$sctr->numsctr}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="femision" id="femision"
                                                   placeholder="AAAA-MM-DD" class="form-control fecha" value="{{$sctr->femision}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="fvencimiento" id="fvencimiento"
                                                   placeholder="AAAA-MM-DD" class="form-control fecha" value="{{$sctr->fvencimiento}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <select name="estado" id="estado"
                                                ...
                                                <option value="1" {{$sctr->estado == '1' ? 'selected' : ''}}>Activo</option>
                                                <option value="0" {{$sctr->estado == '0' ? 'selected' : ''}}>Cesado</option>
                                            </select>
                                        </div>
                                    </div>

                                    <input type="hidden" name="id_user" id="id_user" value="{{ Auth::user()->id }}">
                                    <input type="hidden" name="idempleado" id="idempleado" value="{{ $sctr->idempleado }}">
